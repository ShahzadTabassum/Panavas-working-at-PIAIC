...
let store_name:string[] = ["Ali","Imran","Zaryab Khan","Shami"];

for(let index = 0; index < store_name.length; index++){
...
for(let index = 0; index<store_name.length;index++){
    console.log(`Hi ${store_name[index]} Thank you for contect us. We will Responce you ASAP`)
}